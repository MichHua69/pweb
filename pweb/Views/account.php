...
// Query untuk mengambil data dari database dengan limit dan offset
$query = "SELECT user_id, username, password FROM users LIMIT $rowsPerPage OFFSET $offset";
$result = $conn->query($query);

// Hitung total baris di database
        ...
        <main class="flex-grow relative">
            ...
            <div class="bg-white p-4 md:p-6 rounded shadow m-4 md:m-8">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button class="bg-blue-500 text-white px-3 md:px-4 py-2 rounded hover:bg-blue-600 text-sm md:text-base">
                        + Tambah Data
                    </button>
                </div>
                    ...
                    <table class="min-w-full text-sm md:text-base text-left">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="w-96 py-2 md:py-3 px-3 md:px-6"><?php echo htmlspecialchars($row['password']); ?></td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
                ...
                <div class="absolute justify-center mx-auto bg-white z-50 shadow">
                    <div class="flex justify-center">
                        <div class="flex w-full max-w-lg justify-between items-center">
                            ...
                            <div>
                                <?php if ($page > 1): ?>
                                <a href="?page=<?php echo $page - 1; ?>" class="py-2 px-3 md:px-4 text-gray-500 bg-white rounded-l hover:bg-gray-100 min-w-[100px]">&laquo; Previous</a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="flex grow justify-center">
                                ...
                                <a href="?page=<?php echo $i; ?>" class="py-2 px-3 md:px-4 text-gray-700 bg-white <?= ($i == $page) ? 'text-blue-500' : 'border-x border-gray-300'; ?> hover:bg-gray-100"><?php echo $i; ?></a>
                                <?php endfor; ?>
                            </div>
                            ...
                            <div>
                                ...
                                <a href="?page=<?php echo $page + 1; ?>" class="py-2 px-3 md:px-4 text-gray-700 bg-white rounded-r hover:bg-gray-100">Next &raquo;</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
